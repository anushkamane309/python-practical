...
discount = 0
if Total_bill >= 1000:
    discount = Total_bill * 0.10  # 10% discount for bills above Rs. 1000
    print("Discount applied: Rs.", discount)
elif Total_bill >= 500:
    discount = Total_bill * 0.05  # 5% discount for bills above Rs. 500
    print("Discount applied: Rs.", discount)
else:
